...
void main() {
  final FlutterCachedUuidPlatform initialPlatform = FlutterCachedUuidPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockFlutterCachedUuidPlatform fakePlatform = MockFlutterCachedUuidPlatform();
