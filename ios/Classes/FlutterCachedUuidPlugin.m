#import "FlutterCachedUuidPlugin.h"
#import "SSFlappyKeychain.h"

@implementation FlutterCachedUuidPlugin
{
    NSString* uuid;
}
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"flutter_cached_uuid"
            binaryMessenger:[registrar messenger]];
  FlutterCachedUuidPlugin* instance = [[FlutterCachedUuidPlugin alloc] init];
